...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Reporte>(entity =>
        {
            ...
            // <<< INICIO: MAPEANDO LAS NUEVAS PROPIEDADES BIT/BOOL >>>
            entity.Property(e => e.Defragmentar).HasColumnName("defragmentar");
            entity.Property(e => e.WindowsConfiguracion).HasColumnName("windows_configuracion");
            entity.Property(e => e.ActualizacionDrivers).HasColumnName("actualizacion_drivers");
            entity.Property(e => e.LimpiezaTotal).HasColumnName("limpieza_total");
            entity.Property(e => e.DiscoDuroFisico).HasColumnName("disco_duro_fisico");
            entity.Property(e => e.TecladoFisico).HasColumnName("teclado_fisico");
            entity.Property(e => e.MemoriaFisico).HasColumnName("memoria_fisico");
            entity.Property(e => e.RedFisico).HasColumnName("red_fisico");
            entity.Property(e => e.PantallaMonitorFisico).HasColumnName("pantalla_monitor_fisico");
            entity.Property(e => e.DiscoDuroReemplazo).HasColumnName("disco_duro_reemplazo");
            entity.Property(e => e.TecladoReemplazo).HasColumnName("teclado_reemplazo");
            entity.Property(e => e.MemoriaReemplazo).HasColumnName("memoria_reemplazo");
            entity.Property(e => e.RedReemplazo).HasColumnName("red_reemplazo");
            entity.Property(e => e.PantallaMonitorReemplazo).HasColumnName("pantalla_monitor_reemplazo");
            // <<< FIN: MAPEANDO LAS NUEVAS PROPIEDADES BIT/BOOL >>>
